...
if(isset($_POST['name'])){
    ...
    {
        $sql = "INSERT INTO `registration` (`name`, `username`, `bdate`, `age`, `gender`, `c_number`, `address`, `email`, `password`, `acc_number`, `dt`) VALUES ('$name', '$username', '$bdate', '$age', '$gender', '$c_ntact', '$address', '$email', '$password', '$acc_number', current_timestamp());";
    
    
       $result = mysqli_query($con, $sql);
        if($result)
         {
            header("location: 5_SignIn_1.php"); 
         }
    }
}
...
<body>
    ...
    <div class="Details">
        <form action="7_SignUp_1.php" method= "post">
            <div>
